...
// CargoConfigListLoader.java --
//
// CargoConfigListLoader.java is part of ElectricCommander.
//
...
public class CargoConfigListLoader
    extends Loader
{
    ...
    public CargoConfigListLoader(
            CargoConfigList configList,
            Component       component,
            ChainedCallback callback)
    {
        super(component, callback);
        m_configList      = configList;
        m_cgiRequestProxy = new CgiRequestProxy(InternalComponentBaseFactory
                    .getPluginName(), "cargo.cgi");
    }
    ...
    private void loadConfigs(Map<String, String> cgiParams)
    {
        ...
        try {
                    ...
                    new RequestCallback() {
                                ...
                                Throwable exception)
                        {
                            ...
                            ((HasErrorPanel) m_component).addErrorMessage(
                                "Error loading Cargo configuration list: ",
                                exception);
                        }
            ...
            if (m_component instanceof HasErrorPanel) {
                ...
                // noinspection HardCodedStringLiteral
                ((HasErrorPanel) m_component).addErrorMessage(
                    "Error loading Cargo configuration list: ", e);
            }
            else {
                m_component.getLog()
                           .error(e);
    ...
    private void loadEditors()
    {
        ...
        request.setPropertyName("/plugins/EC-Cargo/project/ui_forms/"
                + m_editorName);
        request.setExpand(false);
        request.setCallback(new EditorLoaderCallback("cargocfg"));
        ...
        implements PropertyCallback
    {
        ...
        @Override public void handleResponse(Property response)
        {
            ...
            String errorMsg = "Editor '" + m_editorName
                    + "' not found for Cargo plugin '" + m_configPlugin
                    + "'";
