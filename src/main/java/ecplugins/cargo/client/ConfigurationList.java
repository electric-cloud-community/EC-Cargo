    ...
    extends ListBase
{
    ...
    private final CargoConfigList m_configList;
    ...
    public ConfigurationList()
    {
        ...
        super("ecgc", "Cargo Configurations", "All Configurations");
        m_configList = new CargoConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        Loader loader = new CargoConfigListLoader(m_configList,
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-Cargo/project");
    ...
    private void loadList()
    {
        ...
        if (!m_configList.isEmpty()) {
            listTable.addHeaderRow(true, "Configuration Name", "Container");
        }
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            // Url
            String configContainer      = m_configList.getConfigContainer(
                    configName);
            Label  configContainerLabel = new Label(configContainer);
            ...
            ClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the Cargo configuration '"
                            + configName + "'?") {
            ...
            listTable.addRow(configNameLabel, configContainerLabel, actions);
        }
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "cargoMonitor.cgi");
